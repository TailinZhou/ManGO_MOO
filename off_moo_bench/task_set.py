...
ToyExample = list(ToyExampleDict.values())
...
ALLTASKS = SyntheticFunction + MONAS + MOCO + MORL + ScientificDesign + RESuite + ToyExample
ALLTASKSDICT = {
    **SyntheticFunctionDict,
    **MONASSequenceDict,
    **MONASLogitsDict,
...
CONTINUOUSTASKS = SyntheticFunction + MONASLogits + MOCOContinuous + MORL + ScientificDesignContinuous + RESuite + ToyExample
