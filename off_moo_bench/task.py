...
class Task(object):
    ...
    def __init__(self, dataset: Union[DatasetBuilder, type, str],
                 ...
                 dataset_kwargs=None, problem_kwargs=None, relabel=False, subsample=False):
        ...
        if callable(dataset):
            # print(dataset_kwargs["max_samples"])
        ...
        # get pf for dataset
        try:
            self.dataset.pf = self.problem.get_pareto_front()
        except:
            print(f"No get Pareto front from problem '{self.problem_name}")
    ...
    def normalize_x(self, x, normalization_method='None'):
        ...
        return self.dataset.normalize_x(x, normalization_method)
    ...
    def normalize_y(self, y, normalization_method='None'):
        ...
        return self.dataset.normalize_y(y,normalization_method)
