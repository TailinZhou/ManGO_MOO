...
register('TE1-Exact-v0',
         'off_moo_bench.datasets.continuous.toy_example_dataset:TE1Dataset',
         'off_moo_bench.problem.synthetic_func:TE1',
...
register('5G-Exact-v0',
         'off_moo_bench.datasets.continuous.fiveg_dataset:FiveGDataset',
         'off_moo_bench.problem.synthetic_func:FIVEG',
