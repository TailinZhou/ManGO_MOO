...
# sudo apt update
# sudo apt conda install g++ 
# sudo apt-get conda upgrade libstdc++6
...
cd ~/ManGO_MOO
conda env create -f environment_mango.yml
conda activate mango4moo
...
pip install torch==2.0.1 torchaudio==2.0.2 --index-url https://download.pytorch.org/whl/cu118  -i https://pypi.tuna.tsinghua.edu.cn/simple
pip install pytorch-lightning==1.6.0  -i https://pypi.tuna.tsinghua.edu.cn/simple
pip install cloudpickle==1.2.0 omegaconf==2.1.0    -i https://pypi.tuna.tsinghua.edu.cn/simple
 
cd off_moo_bench/problem/lambo
pip install -e .
cd ../../../

pip install  scipy==1.10.1 scikit-learn==0.21.3 -i https://pypi.tuna.tsinghua.edu.cn/simple
pip install --upgrade pandas  -i https://pypi.tuna.tsinghua.edu.cn/simple
pip install --upgrade kiwisolver -i https://pypi.tuna.tsinghua.edu.cn/simple
# pip install wandb==0.12.21 -i https://pypi.tuna.tsinghua.edu.cn/simple
...
bash fix_contents.sh ${YOUR_PATH_TO_CONDA}/envs/mango4moo/lib/python3.8/site-packages/sklearn/cross_decomposition/pls_.py "pinv2" "pinv"
...
#For pymoo, copy the __init__.py file to the pymoo package folder in conda env
cp __init__.py   ${YOUR_PATH_TO_CONDA}/envs/mango4moo/lib/python3.8/site-packages/pymoo/problems/__init__.py
...
# mkdir ${YOUR_PATH_TO_CONDA}/envs/mango4moo/include/X11
# mkdir ${YOUR_PATH_TO_CONDA}/envs/mango4moo/include/GL
# sudo cp /usr/include/X11/*.h ${YOUR_PATH_TO_CONDA}/envs/mango4moo/include/X11/
# sudo cp /usr/include/GL/*.h ${YOUR_PATH_TO_CONDA}/envs/mango4moo/include/GL
